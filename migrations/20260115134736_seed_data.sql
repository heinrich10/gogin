...
INSERT INTO `country`
(`code`, `name`, `phone`, `symbol`, `capital`, `currency`, `continent_code`, `alpha_3`)
VALUES ('AF', 'Afghanistan', 93, '؋', 'Kabul', 'AFN', 'AS', 'AFG'),
...
INSERT INTO `person` (`last_name`, `first_name`, `country_code`)
VALUES ('Doe', 'John', 'US'),
       ('Cole', 'Adam', 'ES'),
       ('Best', 'Gianluca', 'GB'),
       ('Lyons', 'Brianna', 'AU'),
